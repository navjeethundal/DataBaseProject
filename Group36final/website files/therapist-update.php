...
mysqli_close($con);
echo "Update therapist number:  " . $StaffNo . "<br><br>";
?>


 <form action="therapist-view.php?job=update" method="post">
   ...
   Monthly Room Rent: <input type="number" name="MonthlyRoomRent" value='<?php echo $MonthlyRoomRent;?>'><br>
   Wage Percentage: <input type="number" name="WagePercentage" value='<?php echo $WagePercentage;?>' ><br>
